...
class View__Edit_Congregation extends View
{
	...
	function printView()
	{
		...
		if ($show_form) {
			?>
			<form method="post" id="congregation_form">
				<input type="hidden" name="edit_congregation_submitted" value="1" />
				<?php $this->_congregation->printForm(); ?>
				<input type="submit" value="Update Congregation" />
				<a href="?view=admin__congregations"></a><input type="button" value="Cancel" class="link-button" />
			</form>
